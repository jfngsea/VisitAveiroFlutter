...
class LocaisGastronomiaPage extends StatelessWidget {
  const LocaisGastronomiaPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final locals = Hive.box<Local>('Locals')
        .values
        .where((local) => local.type == LocalType.Gastronomia)
        .toList();

 return Scaffold(
      appBar: AppBar(
        title: const Text('Gastronomy' , style: TextStyle(color: Colors.white)),
